                        ...
                        <table className="w-full text-left text-sm border-collapse">
                            <thead className="bg-[#1e2329] text-[var(--color-b-muted)] sticky top-0">
                                <tr>
                                    ...
                                    <th className="p-4 border-b border-[var(--color-b-border)] font-semibold text-center cursor-pointer hover:text-white" title="Teknik + temel analizin harmanlandığı genel cazibe puanı (0-100); yüksek = daha güçlü fırsat." onClick={() => requestSort('kompozit_skor')}>🏆 V6 Hibrit Skor{renderSortArrow('kompozit_skor')}</th>
                                    <th className="p-4 border-b border-[var(--color-b-border)] font-semibold cursor-pointer hover:text-white" title="Sinyalin ne kadar sağlam/güvenilir olduğu (0-100); üst fitil, zayıf hacim ve ortalamadan aşırı uzaklık gibi risklerle düşer." onClick={() => requestSort('pgs')}>Güven Skoru{renderSortArrow('pgs')}</th>
